                ...
                <div class="am-u-lg-12">
                    <div class="am-form-group">
                        <div class="am-input-group">
                            ...
                            <input id="input-email" type="email" class="am-form-field" placeholder="邮箱" data-validation-message="请输入正确的邮箱地址" required>
                        </div>
                    </div>
                </div>
                <div class="am-u-lg-12">
                    <div class="am-form-group">
                        <div class="am-input-group">
                            ...
                            <input id="input-phone" type="text" class="am-form-field js-pattern-mobile" placeholder="手机号" data-validation-message="请输入11位大陆手机号" required>
                        </div>
                    </div>
                </div>
                <div class="am-u-lg-12">
                    <div class="am-form-group">
                        <div class="am-input-group">
                            ...
                            <input id="input-username" type="text" class="am-form-field" minlength="3" maxlength="16" placeholder="用户名 (3-16位字符)" required>
                        </div>
                    </div>
                </div>
                <div class="am-u-lg-12">
                    <div class="am-form-group">
                        <div class="am-input-group">
                            ...
                            <input id="input-pwd" type="password" class="am-form-field" minlength="6" maxlength="20" placeholder="密码 (6-20位字符)" required>
                        </div>
                    </div>
                </div>
                <div class="am-u-lg-12">
